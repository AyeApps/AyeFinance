...
export const DashboardScreen: React.FC<DashboardScreenProps> = ({ onNavigate, onOpenQuickAdd }) => {
  ...
  const numAccountRows = Math.max(1, Math.ceil(accounts.length / 2));
  // Desktop height harmonization: 1 row of accounts (~115px) perfectly matches 2 transaction rows (~58px each).
  // If few accounts (1 row), show 3-4 transactions so it doesn't overflow.
  // If many accounts (N rows), show N * 2 transactions so both columns match vertically.
  const desktopTxCount = accounts.length === 0 ? 3 : Math.max(3, numAccountRows * 2);
  const transactions = allTransactions.slice(0, isDesktop ? desktopTxCount : 6);
  ...
  // Hardening: Memoize credit card strategy calculation (O(N log N) sorting)
  const bestCreditCard = useMemo(() => {
    ...
    return creditCardsWithCycle.length > 0 ? creditCardsWithCycle[0] : null;
  }, [accounts]);

  // Hardening: Memoize intelligent credit cards payment summary (Banxico / Condusef formula)
  const creditPaymentSummary = useMemo(() => {
    return calculateAllCreditCardsPaymentSummary(accounts);
  }, [accounts]);
        ...
        {isLoading ? (
          ...
          <>
            ...
            <View style={[styles.metricsGrid, isDesktop && styles.metricsGridDesktop]}>
              ...
              >
                <View style={[styles.squareCardHeader, isDesktop && styles.squareCardHeaderDesktop]}>
                  <View style={[styles.squareIconBox, isDesktop && styles.squareIconBoxDesktop, { borderColor: colors.accentSuccess, backgroundColor: colors.accentSuccessSubtle }]}>
                    <Wallet size={isDesktop ? 16 : 15} color={colors.accentSuccess} strokeWidth={2.5} />
                  </View>
                ...
                <View style={[styles.squareCardBody, isDesktop && styles.squareCardBodyDesktop]}>
                  <Text style={[styles.squareCardLabel, isDesktop && styles.squareCardLabelDesktop, { color: colors.textSecondary }]}>
                    {(t.dashboard?.liquidAvailable || 'DISPONIBLE LÍQUIDO').toUpperCase()}
                  </Text>
                  <Text
                    style={[styles.squareCardValue, isDesktop && styles.squareCardValueDesktop, { color: colors.textPrimary }]}
                    numberOfLines={1}
                ...
                <View style={[styles.squareCardFooter, isDesktop && styles.squareCardFooterDesktop, { borderTopColor: colors.borderMuted }]}>
                  <View style={[styles.squareDot, isDesktop && styles.squareDotDesktop, { backgroundColor: colors.accentSuccess }]} />
                  <Text style={[styles.squareFooterText, isDesktop && styles.squareFooterTextDesktop, { color: colors.textMuted }]} numberOfLines={1}>
                    {language === 'en' ? 'CASH & CHECKING' : 'EN CAJA Y DÉBITO'}
                  </Text>
                </View>
              </View>
              ...
              >
                <View style={[styles.squareCardHeader, isDesktop && styles.squareCardHeaderDesktop]}>
                  <View style={[styles.squareIconBox, isDesktop && styles.squareIconBoxDesktop, { borderColor: colors.accentInfo, backgroundColor: colors.accentInfoSubtle }]}>
                    <PiggyBank size={isDesktop ? 16 : 15} color={colors.accentInfo} strokeWidth={2.5} />
                  </View>
                  <View style={[styles.statusPill, { borderColor: colors.accentInfo, backgroundColor: colors.accentInfoSubtle }]}>
                    <Text style={[styles.statusPillText, { color: colors.accentInfo }]}>
                      {savingsPct}%
                    </Text>
                  </View>
                </View>
                ...
                <View style={[styles.squareCardBody, isDesktop && styles.squareCardBodyDesktop]}>
                  <Text style={[styles.squareCardLabel, isDesktop && styles.squareCardLabelDesktop, { color: colors.textSecondary }]}>
                    {(t.dashboard?.savingsReserve || 'FONDO DE RESERVA').toUpperCase()}
                  </Text>
                  <Text
                    style={[styles.squareCardValue, isDesktop && styles.squareCardValueDesktop, { color: colors.textPrimary }]}
                    numberOfLines={1}
                ...
                <View style={[styles.squareCardFooter, isDesktop && styles.squareCardFooterDesktop, { borderTopColor: colors.borderMuted }]}>
                  <View style={[styles.squareDot, isDesktop && styles.squareDotDesktop, { backgroundColor: colors.accentInfo }]} />
                  <Text style={[styles.squareFooterText, isDesktop && styles.squareFooterTextDesktop, { color: colors.textMuted }]} numberOfLines={1}>
                    {language === 'en' ? 'SAVINGS & INVEST' : 'AHORRO E INVERSIÓN'}
                  </Text>
                </View>
              </View>
              ...
              >
                <View style={[styles.squareCardHeader, isDesktop && styles.squareCardHeaderDesktop]}>
                  <View style={[styles.squareIconBox, isDesktop && styles.squareIconBoxDesktop, { borderColor: colors.accent, backgroundColor: colors.accentSubtle }]}>
                    <Landmark size={isDesktop ? 16 : 15} color={colors.accent} strokeWidth={2.5} />
                  </View>
                ...
                <View style={[styles.squareCardBody, isDesktop && styles.squareCardBodyDesktop]}>
                  <Text style={[styles.squareCardLabel, isDesktop && styles.squareCardLabelDesktop, { color: colors.textSecondary }]}>
                    {(t.dashboard?.totalSavings || 'PATRIMONIO TOTAL').toUpperCase()}
                  </Text>
                  <Text
                    style={[styles.squareCardValue, isDesktop && styles.squareCardValueDesktop, { color: colors.textPrimary }]}
                    numberOfLines={1}
                ...
                <View style={[styles.squareCardFooter, isDesktop && styles.squareCardFooterDesktop, { borderTopColor: colors.borderMuted }]}>
                  <View style={[styles.squareDot, isDesktop && styles.squareDotDesktop, { backgroundColor: colors.accent }]} />
                  <Text style={[styles.squareFooterText, isDesktop && styles.squareFooterTextDesktop, { color: colors.textMuted }]} numberOfLines={1}>
                    {language === 'en' ? 'NET CONSOLIDATED' : 'SALDO NETO GLOBAL'}
                  </Text>
                </View>
              </View>
              ...
              >
                <View style={[styles.squareCardHeader, isDesktop && styles.squareCardHeaderDesktop]}>
                  <View style={[styles.squareIconBox, isDesktop && styles.squareIconBoxDesktop, { borderColor: colors.accentWarning, backgroundColor: colors.accentWarningSubtle }]}>
                    <TrendingUp size={isDesktop ? 16 : 15} color={colors.accentWarning} strokeWidth={2.5} />
                  </View>
                ...
                <View style={[styles.squareCardBody, isDesktop && styles.squareCardBodyDesktop]}>
                  <Text style={[styles.squareCardLabel, isDesktop && styles.squareCardLabelDesktop, { color: colors.textSecondary }]}>
                    {(t.dashboard?.projectedTotal || 'PROYECCIÓN 30D').toUpperCase()}
                  </Text>
                  <Text
                    style={[styles.squareCardValue, isDesktop && styles.squareCardValueDesktop, { color: colors.accentWarning }]}
                    numberOfLines={1}
                    adjustsFontSizeToFit
                  >
                ...
                <View style={[styles.squareCardFooter, isDesktop && styles.squareCardFooterDesktop, { borderTopColor: colors.borderMuted }]}>
                  <View style={[styles.squareDot, isDesktop && styles.squareDotDesktop, { backgroundColor: colors.accentWarning }]} />
                  <Text style={[styles.squareFooterText, isDesktop && styles.squareFooterTextDesktop, { color: colors.textMuted }]} numberOfLines={1}>
                    {language === 'en' ? 'ESTIMATED 30 DAYS' : 'ESTIMADO 30 DÍAS'}
                  </Text>
                </View>
              </View>
            </View>
            ...
            >
              ...
              <View style={styles.allocationLegendRow}>
                ...
                <View style={styles.legendItem}>
                  <View style={[styles.legendDot, { backgroundColor: colors.accentInfo }]} />
                  <Text style={[styles.legendText, { color: colors.textSecondary }]}>
                  ...
                  >
                    <View style={styles.rewardsDashboardHeader}>
                      <View style={styles.rewardsHeaderLeft}>
                        <Sparkles size={15} color={colors.accentSuccess} strokeWidth={2.5} />
                        <Text style={[styles.rewardsDashboardTag, { color: colors.accentSuccess }]}>
                    ...
                    <View style={styles.rewardsAmountsRow}>
                      {parseFloat(String(summary?.month_cashback ?? '0')) > 0 && (
                        <View style={styles.rewardsAmountCol}>
                          <Text style={[styles.rewardsAmountValue, { color: colors.accentSuccess }]}>
                ...
                {bestCreditCard && (
                  ...
                  >
                    <View style={styles.bestCardHeader}>
                      ...
                      <View style={[styles.statusPill, { borderColor: colors.accent, backgroundColor: colors.accentSubtle }]}>
                        <Text style={[styles.statusPillText, { color: colors.accent }]}>
                          {bestCreditCard.cycle.daysOfFinancing} DÍAS LIBRES
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.bestCardBody}>
                      <View style={styles.bestCardMainRow}>
                        ...
                        <Text style={[styles.bestCardName, { color: colors.textPrimary }]}>
                          {bestCreditCard.account.name.toUpperCase()}
                        </Text>
                        {bestCreditCard.account.card_product ? (
                          <View style={[styles.productPill, { borderColor: colors.borderMuted, backgroundColor: colors.bgBase }]}>
                            <Text style={[styles.productPillText, { color: colors.accent }]}>
                              {bestCreditCard.account.card_product.toUpperCase()}
                            </Text>
                          </View>
                        ) : null}
                      </View>
            ...
            {creditPaymentSummary.cardsWithDebt.length > 0 && (() => {
              const paymentSummary = creditPaymentSummary;
              return (
                <View style={styles.sectionContainer}>
                  <View
                    style={[
                          ...
                          >
                            <View style={styles.creditCardItemTop}>
                              ...
                              <TouchableOpacity
                                ...
                                accessibilityLabel={`Pagar tarjeta ${card.account.name}`}
                                activeOpacity={0.8}
                              >
                          ...
                          >
                            <View style={styles.accountBoxTop}>
                              <View style={styles.accountTypeRow}>
                                <BankAvatar bankId={resolvedBankId} size={22} />
                              ...
                              >
                                <Text style={[styles.accountPillBadgeText, { color: colors.textSecondary }]}>
                                  {acc.account_type === 'corriente' ? 'DÉB' : acc.account_type === 'credito' ? 'TDC' : acc.account_type.toUpperCase()}
                                </Text>
                              </View>
                            </View>

                            <Text
                              style={[styles.accountBalanceNumber, { color: colors.textPrimary }]}
                              numberOfLines={1}
                              adjustsFontSizeToFit
                            >
                            ...
                            <View style={[styles.accountFooterRow, { borderTopColor: colors.borderMuted }]}>
                              <Text style={[styles.accountProjLabel, { color: colors.textMuted }]} numberOfLines={1}>
                                {acc.account_type === 'credito' && acc.credit_limit ? 'DISP:' : 'PROY:'}
                              </Text>
                              <Text
                                style={[
                    ...
                    <View style={styles.txListContainer}>
                      ...
                      {allTransactions.length > transactions.length && (
                        <TouchableOpacity
                          ...
                          activeOpacity={0.7}
                          accessibilityLabel={language === 'en' ? 'View full ledger' : 'Ver libro completo'}
                        >
                          <Text style={[styles.moreTxText, { color: colors.accent }]}>
                            +{allTransactions.length - transactions.length} {language === 'en' ? 'MORE TRANSACTIONS IN FULL LEDGER' : 'MOVIMIENTOS MÁS EN EL LIBRO'}
                          </Text>
                          <ArrowRight size={13} color={colors.accent} strokeWidth={2.5} />
                        </TouchableOpacity>
                      )}
                    </View>
                  )}
