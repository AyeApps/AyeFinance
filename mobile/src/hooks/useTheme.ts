...
export const useThemeStore = create<ThemeState>((set, get) => ({
  ...
  setThemePreference: async (preference: ThemePreference) => {
    ...
    const newColors = getThemeColors(effective);
    if (typeof document !== 'undefined' && document.body) {
      document.body.style.backgroundColor = newColors.bgBase;
      document.documentElement.style.backgroundColor = newColors.bgBase;
    }
    set({
