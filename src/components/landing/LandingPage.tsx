...
export const LandingPage: React.FC<LandingPageProps> = ({ onStartAuth }) => {
  ...
  const t = {
    es: {
      badge: '✦ AYEFINANCE · CONTROL DE GASTOS Y FLUJO DE CAJA',
      heroTitle: 'Control claro y ordenado de tus finanzas, cuentas y flujo diario.',
      heroSub: 'Lleva el pulso de tu dinero en un solo lugar. Registra movimientos al instante, monitorea tus gastos fijos y proyecta tus finanzas personales sin configuraciones complejas.',
      ctaBtn: 'COMENZAR AHORA ➔',
      loginBtn: 'INICIAR SESIÓN',
      feature1Title: 'Gestión Multicuenta',
      feature1Desc: 'Centraliza tus cuentas de débito, crédito, efectivo y billeteras digitales con saldos sincronizados al momento.',
      feature2Title: 'Control de Flujo de Caja',
      feature2Desc: 'Registra tus ingresos y gastos diarios en segundos para tener claridad total de en qué se gasta cada centavo.',
      feature3Title: 'Gastos Fijos y Recurrentes',
      feature3Desc: 'Monitorea tus suscripciones y compromisos recurrentes para anticipar fechas de corte y evitar sorpresas.',
      securityTitle: 'Privacidad y Control Total',
      securityDesc: 'Tus registros financieros son estrictamente confidenciales. Sin rastreo publicitario ni venta de datos.',
      footerText: 'AyeFinance es parte del ecosistema de software AyeApps. Diseñado para simplificar tu economía personal.',
    },
    en: {
      badge: '✦ AYEFINANCE · CASHFLOW & EXPENSE TRACKER',
      heroTitle: 'Clear, effortless control over your finances, accounts, and daily cashflow.',
      heroSub: 'Keep your financial pulse in one place. Log transactions instantly, track fixed commitments, and forecast your personal runway without painful manual spreadsheets.',
      ctaBtn: 'GET STARTED NOW ➔',
      loginBtn: 'SIGN IN',
      feature1Title: 'Multi-Account Hub',
      feature1Desc: 'Track checking, savings, credit cards, cash, and digital wallets with instant balance updates across all assets.',
      feature2Title: 'Daily Cashflow Tracking',
      feature2Desc: 'Categorize income and expenses in seconds to understand exactly where your money goes every single week.',
      feature3Title: 'Fixed & Recurring Expenses',
      feature3Desc: 'Stay ahead of upcoming subscriptions, bills, and recurring payments before due dates catch you off guard.',
      securityTitle: 'Privacy & Complete Ownership',
      securityDesc: 'Your financial ledger remains strictly confidential. Zero third-party ad networks, zero data selling.',
      footerText: 'AyeFinance is part of the AyeApps software suite. Designed for personal financial clarity.',
    },
  }[isEs ? 'es' : 'en'];
      ...
      <View style={[styles.gridSection, isMobile && styles.gridSectionMobile]}>
        ...
        >
          <View style={[styles.cardIconBox, { backgroundColor: colors.accentSubtle, borderColor: colors.borderColor }]}>
            <Landmark size={24} color={colors.accent} strokeWidth={2.2} />
          </View>
        ...
        >
          <View style={[styles.cardIconBox, { backgroundColor: colors.accentSubtle, borderColor: colors.borderColor }]}>
            <Receipt size={24} color={colors.accent} strokeWidth={2.2} />
          </View>
        ...
        >
          <View style={[styles.cardIconBox, { backgroundColor: colors.accentSubtle, borderColor: colors.borderColor }]}>
            <CalendarClock size={24} color={colors.accent} strokeWidth={2.2} />
          </View>
